<?php
$title = 'Windows Longbridge - The Longhorn Experience Reimagined';
$currentPage = 'home';
...
<div class="panel">
  ...
  <div class="grid">
    <div class="card">
      ...
      <div><h3>“Perfect Mix” Experience</h3><p>Aurora, Plex, Jade/Slate, live together.</p></div>
    </div>
    <div class="card">
      <img src="https://www.iconshock.com/image/Vista/General/hourglass" alt="">
      <div><h3>Custom Animations</h3><p>Longhorn/Vista-style fluidity revived.</p></div>
    </div>
    <div class="card">
      ...
      <div><h3>Hidden Gems</h3><p>WinFS search, sidebar gadgets, prototype UI.</p></div>
    </div>
    <div class="card">
...
<aside class="sidebar">
  ...
  <ul>
    ...
    <li><img src="https://www.iconshock.com/image/Vista/General/book" alt=""> <a href="/about.aspx">Docs</a></li>
  </ul>
</aside>
