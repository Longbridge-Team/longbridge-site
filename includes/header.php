...
<header>
  <nav>
    <ul>
      <li><a <?php if($currentPage=='home') echo 'class="active"'; ?> href="/"><img height="40" width="40" src="https://external-content.duckduckgo.com/iu/?u=http%3A%2F%2Fwww.rw-designer.com%2Ficon-image%2F18837-256x256x4.png&f=1&nofb=1&ipt=f7d794f16772d7f4e0c9a6e94728373825d3c62652593016b99b5592e6f2ea32" alt="Home">Home</a></li>
      <li><a <?php if($currentPage=='features') echo 'class="active"'; ?> href="/features.php"><img height="40" width="40" src="https://images.freeimages.com/fic/images/icons/679/nx10/256/windows_update.png" alt="Features">Features</a></li>
      ...
      <li><a <?php if($currentPage=='about') echo 'class="active"'; ?> href="/about.php"><img height="40" width="40" src="https://www.iconshock.com/image/Vista/General/file" alt="About">About</a></li>
