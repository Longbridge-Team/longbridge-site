<?php
$title = 'Windows Longbridge - Features';
...
<div class="panel">
  ...
  <div class="grid">
    <div class="card">
      ...
      <div><h3>"Perfect Mix" Theme</h3><p>Aurora backgrounds, Plex chrome and community-crafted Jade/Slate visuals.</p></div>
    </div>
    <div class="card">
      <img src="https://www.iconshock.com/image/Vista/General/hourglass" alt="">
      <div><h3>Custom Animations</h3><p>Smooth transitions revive the experimental Longhorn demos.</p></div>
    </div>
    <div class="card">
      <img src="https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fbetawiki.net%2Fimages%2F7%2F77%2FWindows_Sidebar_beta_logo.png%3F20220519010711&f=1&nofb=1" alt="">
      <div><h3>Sidebar Gadgets</h3><p>Gadgets and WinFS-style search bring futuristic flair.</p></div>
    </div>
  </div>
</div>
...
<div class="panel">
  ...
  <div class="grid">
    ...
    <div class="card">
      <img src="https://www.iconshock.com/image/RealVista/Mobile/calendar" alt="">
      <div><h3>Classic Widgets</h3><p>Desktop widgets for quick info at a glance.</p></div>
    </div>
  </div>
</div>
