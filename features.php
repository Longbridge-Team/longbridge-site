...
<div class="panel">
  ...
  <div class="grid">
    <div class="card">
      ...
      <div><h3>"Perfect Mix" Experience</h3><p>Aurora backgrounds, Plex themes and community recreated Jade/Slate styles.</p></div>
    </div>
    <div class="card">
      <img src="https://www.iconshock.com/image/Vista/General/hourglass" alt="">
      <div><h3>Custom Animations</h3><p>Smooth transitions from Longhorn prototypes and Vista.</p></div>
    </div>
    <div class="card">
      ...
      <div><h3>Hidden Gems</h3><p>WinFS-inspired search and sidebar gadgets make a return.</p></div>
    </div>
    <div class="card">
      ...
      <div><h3>Legacy Restored</h3><p>Classic Movie Maker, Photo Gallery and retro widgets.</p></div>
    </div>
  </div>
</div>
